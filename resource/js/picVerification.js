(function(window, factory) {
    if (typeof picVerification !== 'function') {
        window.picVerification = factory();
    }

}(window, function() {
    var picVerification = function(ele, lock) {
        var htmlStr = `
			<div class="container2">
				...
				<div class="dibu">
					...
					<span class="tips"><h5>拖动滑块使图片对齐<h5></span>
				</div>
        ...
        function initImg() {
            ...
            img.crossOrigin = "Anonymous"
                // var url = timestamp("http://www.dmoe.cc/random.php");
